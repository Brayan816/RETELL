        ...
        try
        {
            if(OpenConnection()) {
                if(E_C)
                {
                    ...
                    preparedStatement.executeUpdate();
                    UC.Comentario_Consulta="REGISTRADO EXITOSAMENTE";
                    Check=true;
                }
                else {
                    String Query="INSERT INTO llantas (N_IDE,MARCA,TAMA,SERIE,COSTADO,BANDA,HOMBRO,OTRO,FECHA,ORDEN_S,VALOR,ABONO,E_A,UBICACION,POSICION,FECHAS,FECHAE,TIPO_S,FECHAG,M1,M2,M3,M4,M5,M6,N1,N2,N3,N4,N5,N6,PM1,PM2,PM3,PM4,PM5,PM6,hLargo,hAncho,hProfundidad,hAlambres)VALUES ("
                    ...
                    UC.Comentario_Consulta="llanta Y USUARIO REGISTRADO EXITOSAMENTE"+results.toString();
                    Check=true;
                }
            }
        }
        catch (Exception E){
            UC.Comentario_Consulta=E.getMessage()+E_C;
        }
        CloseConnection();
        return Check;
    }
        ...
        try {
            if (OpenConnection()) {
                ...
                if (fr.next()) {
                    ...
                    UC.Comentario_Consulta="Datos cargados exitosamente";
                    Check=true;
                }
            }
        }
    ...
    public Boolean ActualizarMateriales(){
        ...
        try {
            if(OpenConnection()){
                ...
                UC.Comentario_Consulta="Ocurrio Un error al Actualizar los materiales";
            }
        }
        catch (Exception E){
            UC.Comentario_Consulta=E.getMessage();
    ...
    public Boolean Editar_Datos(String A1){
        ...
        try {
            if(OpenConnection()){
                ...
                UC.Comentario_Consulta="Ocurrio un problema al raalizar el cambio de los datos";
            }
        }
        catch (Exception E){
            UC.Comentario_Consulta=E.getMessage();
