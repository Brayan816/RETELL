package app.jabrex.retell.ui.login;
...
import app.jabrex.retell.provider.retellServer.ConexionMysql;
import app.jabrex.retell.navegacion;
...
public class ActivityLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ipAddress.charAt(8)=='0'){
            UC.DBIP="192.168.0.200";
        }
        else {
            UC.DBIP="192.168.1.200";
        }
        PERMISOSXD();
    ...
    private void PERMISOSXD() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(), PERMISOS[0]) == PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(ActivityLogin.this, PERMISOS, REQUEST_CODE);
        }
    }
    ...
    class Dback extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            N3=new ProgressDialog(ActivityLogin.this);
            N3.show();
