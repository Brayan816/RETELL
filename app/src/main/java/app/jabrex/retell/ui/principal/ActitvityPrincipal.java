package app.jabrex.retell.ui.principal;
...
import app.jabrex.retell.ui.editarDatos.ActivityEditarDatos;
import app.jabrex.retell.ui.fotos.ActivityFotos;
import app.jabrex.retell.provider.retellServer.*;
import app.jabrex.retell.UC;


public class ActitvityPrincipal extends AppCompatActivity {
    ...
    public void ShowHerida(){
        try {
            dialog2.setContentView(R.layout.popup_herida);
    ...
    public void ShowPopUP(){
        try{
            dialog.setContentView(R.layout.popup_materiales);
    ...
    public void AbrirEditarDatos() {
        Intent intent = new Intent(this, ActivityEditarDatos.class);
    ...
    private class Dback extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            N3=new ProgressDialog(ActitvityPrincipal.this);
            N3.show();
