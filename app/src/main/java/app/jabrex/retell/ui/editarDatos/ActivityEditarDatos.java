package app.jabrex.retell.ui.editarDatos;
...
public class ActivityEditarDatos extends AppCompatActivity {
    ...
    private class Dback extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            N3=new ProgressDialog(ActivityEditarDatos.this);
            N3.show();
            ...
            try{
                if(CASO==0){
                    ...
                    if (Check) {
                        ...
                        ToastGenerator(UC.Comentario_Consulta);
                        FG1.setText(UC.Comentario_Consulta);
                    }
                }
