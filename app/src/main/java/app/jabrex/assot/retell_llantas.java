...
import app.jabrex.assot.ui.slideshow.SlideshowFragment;


public class retell_llantas extends Fragment {

    AutoCompleteTextView TD2;
    Button ENVIAR;
    private TextInputEditText TD1,TD3,TD4,TD5,TD6,TD7,TD9,TD10,TD11,TD12,TD13;
    public String A1,A2,A3,A4,A5,A6,A7,A8,A9,A10,A11,A12,A13,A11S,A12S,A13S,FECHA,FECHAS,A14,HER1="NO",HER2="NO",HER3="NO",A15,A16;
    ...
    public void DATOSB()
    {
        ...
        if(A1.equals("") || A2.equals("") || A3.equals("") || A5.equals("") )
        {
            ...
            ToastGenerator("LLENE TODOS LOS CAMPOS NECESARIOS");
                ...
                retell_llantas.ConexionMysql4 RTD = new retell_llantas.ConexionMysql4();
                RTD.execute("");
        }
    }
